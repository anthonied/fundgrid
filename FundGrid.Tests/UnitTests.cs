...
namespace FundGrid.Tests
{
    ...
    class UnitTests
    {
        ...
        [Test]
        public void ZeroIdGridItemIsAvailibleForUser()
        {
            GridItem item = new GridItem() { Id = 0 };
            Assert.That(item.IsAvailible, Is.True);
        }
        [Test]
        public void NonZeroIdGridItemIsNOTAvailibleForUser()
        {
            GridItem item = new GridItem() { Id = 10 };
            Assert.That(item.IsAvailible, Is.False);
        }
        [Test]
        public void GridWithNoExistingItemsShouldContainCorrectNumberOfItems()
        {
        ...
        [Test]
        public void GridWithExistingItemsShouldPlaceExistingItemsInCorrectPlaces()
        {
